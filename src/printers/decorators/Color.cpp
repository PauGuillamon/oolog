...
namespace oolog {
	namespace printers {
		namespace decorators {
			...
			Color::Color(std::shared_ptr<Printer> origin) :
			...
			void Color::PrintLog(std::string& textToLog, LogLevel logLevel) {
			...
			void Color::SetColor(std::string& textToLog, const LogLevel logLevel) {
			#if defined _WINDOWS
